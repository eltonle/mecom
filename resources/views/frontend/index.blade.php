...
<!--End Best Sales Featured Products-->
                    ...
                    <div class="product-cart-wrap">
                        ...
                        <div class="product-content-wrap">
                            <div class="product-category">
                                <a href="shop-grid-right.html">{{ $product['category']['category_name'] }}s</a>
                            </div>
                            <h2><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug) }}l">{{ $product->product_name }}</a></h2>
