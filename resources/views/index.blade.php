                    ...
                    <div class="col-md-3">
                        <div class="dashboard-menu">
                            <ul class="nav flex-column" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="change_password-tab" data-bs-toggle="tab" href="#change_password" role="tab" aria-controls="change_password" aria-selected="true"><i class="fi-rs-user mr-10"></i>change_password</a>
                                </li>
                                <li class="nav-item">
                                        ...
                                        <form action="{{ route('user.profile.store') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label>Email Name <span class="required">*</span></label>
                                    ...
                                    <div class="card-body">
                                        ...
                                        @endif
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Comfirm New Password <span class="required">*</span></label>
