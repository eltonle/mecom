							...
							<div class="col-lg-8">
								<div class="card">
									<div class="card-body">
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Vendor Date Doin</h6>
											</div>
											<div class="col-sm-9 text-secondary">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
											<textarea name="vendor_short_info" class="form-control" id="inputAddress" placeholder="Short_Info" rows="3">{{$vendorData->vendor_short_info}}</textarea>
											</div>
										</div>
                                        ...
                                        <div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
                                            <img id="showImage" src="{{ (!empty($vendorData->photo))? url('upload/vendor_images/' .$vendorData->photo): url('upload/no_image.jpg') }}"  style="width: 100px; height: 100px;" alt="Vendor">
											</div>
										</div>
										<div class="row">
