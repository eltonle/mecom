...
<!-- MAIN IMAGE THUMBNULL UPDATE  -->
<div class="page-content">
	<h6 class="mb-0 text-uppercase">Update Main Image Thumbnaill</h6>
	<hr>
	<div class="card">
		<form method="post" action="{{ route('vendor.update.product.thambnail') }}" enctype="multipart/form-data">
			...
			<div class="card-body">
				<div class="mb-3">
					...
					<input class="form-control" name="product_thambnail" required type="file" id="formFile">
				</div>

				<div class="mb-3">
					<!-- <label for="formFile" class="form-label">Default file input example</label> -->
					<img src="{{ asset($products->product_thambnail) }}" width="100px" height="100px" alt="">
				</div>
				<input type="submit" class="btn btn-primary px-4" value="Save Changes" />
			</div>
		</form>
...
<!--END MAIN IMAGE THUMBNULL UPDATE  -->
