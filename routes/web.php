...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('/admin/change/password', [AdminController::class, 'AdminChangePassword'])->name('admin.change.pasword');
...
Route::middleware(['auth', 'role:user'])->group(function () {
    ...
    // Compare All Route 
    Route::controller(CompareControler::class)->group(function () {
